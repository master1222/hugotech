...
SECRET_KEY = 'django-insecure-jy%((u+2inn0+$(fg151xoa43x)^tk0i-$_xcb!*a5*n!@p#0q'
...
INSTALLED_APPS = [
    ...
    'bell_scheduler',  # Custom app for managing bell schedules
...
TEMPLATES = [
    {
        ...
        'DIRS': [ os.path.join(BASE_DIR, 'frontend/build'),
                  os.path.join(BASE_DIR), ],  # Directory for custom templates
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'frontend/build/static'),  # Directory for static files
]
